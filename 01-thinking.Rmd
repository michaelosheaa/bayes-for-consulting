# Chapter 1: Thinking generatively
...
# A short psychological example: Satisfaction with job
...
# Concluding remarks and future plans for the full book

This chapter *thinking generatively* is the first chapter of my upcoming short e-book/online tutorial document titled *Statistical shit they don't teach you in psychology.* This chapter will likely be extended and built out more for the full edition. The full document is due to be released soon, though I am unsure if I will release it in chapters or as one full document. Time permitting, it will be the full document next. Please keep your eyes peeled for it. The following topics are will be covered:

* Thinking generatively
* Linear regression and ANOVA are the same thing
* When the normal distribution is inappropriate (generalised linear models)
* Why you should not use linear regression on Likert scales
* Additional useful resources and reading materials

In the meantime, if you have any questions, queries, or spot any errors, please don't hesitate to [email](trent.henderson1@outlook.com) me, or [tweet](https://twitter.com/trentlikesstats) me.
